from homelab_cost_optimizer.models import Node, Workload, PowerProfile
...
def test_estimate_cost_simple():
    from homelab_cost_optimizer.estimators.power_estimator import PowerReport, NodePowerUsage
...
def test_estimate_cost_periods():
    ...
    periods = [
        ElectricityPeriod("Day", 0.20),
        ElectricityPeriod("Night", 0.10)
    ]
